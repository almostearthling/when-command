...
:::{warning}
On some _Wayland_ based Linux environments, idle time is calculated as the time after the session has been locked: this should not be the case of recent version of _Wayland_ though.
:::
