...
UI_FORM_SETWENVIRONMENT = f"Set {UI_ENVVARS} environment variables"
...
UI_FORM_RECURSIVEDIRSCAN = "Recursively scan directories"
UI_FORM_SELECTDIRECTORY = "Use button to select directories"
...
# form titles
UI_TITLE_NEWITEM = f"{UI_APP}: Choose New Item"

UI_TITLE_COMMANDTASK = f"{UI_APP}: Command Task Editor"
UI_TITLE_LUATASK = f"{UI_APP}: Lua Script Task Editor"
UI_TITLE_INTERNALTASK = f"{UI_APP}: Internal Command Task Editor"

UI_TITLE_COMMANDCOND = f"{UI_APP}: Command Condition Editor"
UI_TITLE_LUACOND = f"{UI_APP}: Lua Script Condition Editor"
UI_TITLE_INTERVALCOND = f"{UI_APP}: Interval Condition Editor"
UI_TITLE_IDLECOND = f"{UI_APP}: Idle Session Condition Editor"
UI_TITLE_EVENTCOND = f"{UI_APP}: Event Condition Editor"
...
UI_TITLE_CLIEVENT = f"{UI_APP}: Direct Command Event Editor"
UI_TITLE_WMIEVENT = f"{UI_APP}: WMI Query Event Editor"

UI_TITLE_HISTORY = f"{UI_APP}: Task History"
...
UI_POPUP_DELETEALLENTRIES_Q = "Do you want to delete all entries?"
...
CLI_ERR_WHENEVER_WRONG_VERSION = f"Version of [bold]`{CLI_WHENEVER}`[/] not supported"
