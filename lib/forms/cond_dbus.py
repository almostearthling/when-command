...
class form_DBusCondition(form_Condition):
    ...
    def __init__(self, tasks_available, item=None):
        ...
        cb_dbusBus = ttk.Combobox(
            area, values=_DBUS_BUS_VALUES, width=15, state="readonly"
        )
        ...
        e_dbusObjectPath.grid(
            row=1, column=1, columnspan=3, sticky=tk.EW, padx=PAD, pady=PAD
        )
        l_dbusInterface.grid(row=2, column=0, sticky=tk.W, padx=PAD, pady=PAD)
        e_dbusInterface.grid(
            row=2, column=1, columnspan=3, sticky=tk.EW, padx=PAD, pady=PAD
        )
        ...
        e_dbusMethod.grid(
            row=21, column=1, sticky=tk.EW, columnspan=3, padx=PAD, pady=PAD
        )
        l_dbusParamsCall.grid(
            row=22, column=0, sticky=tk.W, columnspan=4, padx=PAD, pady=PAD
        )
        cv_dbusParamsCall.grid(
            row=23, column=0, sticky=tk.NSEW, columnspan=4, padx=PAD, pady=PAD
        )

        sep3.grid(row=30, column=0, columnspan=4, sticky=tk.EW, pady=PAD)
        l_dbusParamsCheck.grid(
            row=31, column=0, sticky=tk.W, columnspan=4, padx=PAD, pady=PAD
        )
        cv_dbusParamsCheck.grid(
            row=32, column=0, sticky=tk.NSEW, columnspan=4, padx=PAD, pady=PAD
        )
        ck_dbusCheckAll.grid(
            row=33, column=0, sticky=tk.W, columnspan=4, padx=PAD, pady=PAD
        )
