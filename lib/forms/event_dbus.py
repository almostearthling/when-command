...
class form_DBusEvent(form_Event):
    ...
    def __init__(self, conditions_available, item=None):
        ...
        cv_dbusRule.grid(
            row=22, column=0, sticky=tk.NSEW, columnspan=2, padx=PAD, pady=PAD
        )

        sep2.grid(row=30, column=0, columnspan=4, sticky=tk.EW, pady=PAD)
        l_dbusParamsCheck.grid(
            row=31, column=0, sticky=tk.W, columnspan=2, padx=PAD, pady=PAD
        )
        cv_dbusParamsCheck.grid(
            row=32, column=0, sticky=tk.NSEW, columnspan=2, padx=PAD, pady=PAD
        )
